...
export const faq = {
  ...
  sub: "Click any question for a fresh answer generated by your browser's built-in AI. If the browser AI isn't available, we fall back to our knowledge base.",
  items: [
    {
      q: 'How does the AI tutor work?',
      a: 'The AI tutor uses large language models to provide step-by-step explanations tailored to your grade level. Ask a question in plain English and you get a clear, conversational reply backed by our curriculum.',
    },
    {
      q: 'Is my data private?',
      a: "We don't sell your data, and we minimize what we collect. When this FAQ uses Chrome's built-in AI, your question never leaves your device, it runs entirely in your browser.",
    },
    {
      q: 'What grades are supported?',
      a: 'Meadows Tech supports learners from grade K through 12, plus introductory college topics. The AI adapts its explanations to whatever level you tell it you are studying.',
    },
    {
      q: 'How much does Meadows Tech cost?',
      a: 'We have a free tier for trying the AI tutor and five starter courses. Paid plans start at $9 per month for unlimited course access and priority AI support.',
    },
    {
      q: 'Can my school adopt this?',
      a: 'Yes. We offer school and district plans with teacher dashboards, progress reports, and curriculum alignment tools. Contact our team for a demo.',
    },
    {
      q: 'Do I need to install anything?',
      a: 'No installation needed. Meadows Tech runs in any modern web browser on phone, tablet, laptop, or desktop. Modern Chrome unlocks the on-device AI in this FAQ.',
    },
  ],
  customLabel: 'Have a different question?',
  customPlaceholder: 'How can Meadows Tech help me with...',
  customCta: 'Ask',
  poweredBy: "Answered by your browser's built-in AI",
  fallbackUsed: "Browser AI was unavailable, showing our pre-written answer.",
  unavailableBanner:
    "Your browser doesn't include built-in AI yet. Open this page in Chrome 138 or later (with the Prompt API enabled) for live answers. Until then, click a question for an answer from our knowledge base.",
  downloadableBanner:
    'Your browser can download a small on-device AI model. Enable it under chrome://flags by turning on "Prompt API for Gemini Nano", then refresh.',
  downloadingBanner:
